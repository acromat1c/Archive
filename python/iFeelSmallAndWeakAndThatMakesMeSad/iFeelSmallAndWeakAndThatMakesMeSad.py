...
class LinkedList:
    ...
    # Returns all elements in linked list as a list 
    def RemakeList(self):
        if self.isEmpty() == True: return []
        else:
            l = [self.__head.element]
            n = self.__head.next
            while True:
                if n == None: break
                else:
    ...
    def get(self, index):
        if self.isEmpty() == True or index < 0: return None
        else:
            n = self.__head
            i = 0
            while True:
    ...
    def set(self, index, e):
        if self.isEmpty() == False and index >= 0:
            n = self.__head
